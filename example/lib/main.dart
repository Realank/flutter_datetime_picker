...
class CustomPicker extends CommonPickerModel {
  ...
  DateTime finalTime() {
    return currentTime.isUtc
        ? DateTime.utc(
            currentTime.year, currentTime.month, currentTime.day, this.currentLeftIndex(), this.currentMiddleIndex(), this.currentRightIndex())
        : DateTime(
            currentTime.year, currentTime.month, currentTime.day, this.currentLeftIndex(), this.currentMiddleIndex(), this.currentRightIndex());
  }
}
            ...
            TextButton(
                onPressed: () {
                  DatePicker.showGreeRouteDateTimePicker(
                    context,
                    showTitleActions: true,
                    minTime: DateTime(2023, 3, 9, 8, 12),
                    maxTime: DateTime(2023, 3, 10, 7, 11),
