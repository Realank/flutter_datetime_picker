...
class CommonPickerModel extends BasePickerModel {
  CommonPickerModel({this.currentTime, LocaleType? locale}) : locale = locale ?? LocaleType.en;
...
class DatePickerModel extends CommonPickerModel {
  ...
  void _fillLeftLists() {
    leftList = List<String>.generate(maxTime!.year - minTime!.year + 1, (int index) {
  ...
  String _localeMonth(int month) {
    if (locale == LocaleType.zh || locale == LocaleType.jp) {
      ...
      final List<String> monthStrings = i18nObjInLocale(locale!)!['monthLong']! as List<String>;
