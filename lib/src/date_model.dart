...
class YearMonthModel extends CommonPickerModel {
  DateTime maxTime;
  DateTime minTime;

  YearMonthModel({DateTime currentTime, DateTime maxTime, DateTime minTime, LocaleType locale})
      : super(locale: locale) {
...
class Time12hPickerModel extends CommonPickerModel {
  ...
  String rightStringAtIndex(int index) {
    if (index == 0) {
      return i18nObjInLocale(locale)["am"];
    } else if (index == 1) {
      return i18nObjInLocale(locale)["pm"];
    } else {
      return null;
    }
  }
