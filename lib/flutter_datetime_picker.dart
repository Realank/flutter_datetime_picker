...
import 'package:flutter_datetime_picker/src/datetime_picker_theme.dart' as dtp_theme;
...
class DatePicker {
  ...
  static Future<DateTime?> showDatePicker(
    ...
    dtp_theme.DatePickerTheme? theme,
  }) async {
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        this.theme = theme ?? dtp_theme.DatePickerTheme(),
  ...
  final dtp_theme.DatePickerTheme theme;
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    dtp_theme.DatePickerTheme theme = widget.route.theme;
  ...
  Widget _renderPickerView(dtp_theme.DatePickerTheme theme) {
  ...
  Widget _renderItemView(dtp_theme.DatePickerTheme theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(dtp_theme.DatePickerTheme theme) {
